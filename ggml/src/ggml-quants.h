...
GGML_API void quantize_row_mxfp4_ref_uos(const float * GGML_RESTRICT x, block_mxfp4 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_mxfp4_ref_imatrix(const float * GGML_RESTRICT x, const float * GGML_RESTRICT im, block_mxfp4 * GGML_RESTRICT y, int64_t k, int64_t n_per_row);
