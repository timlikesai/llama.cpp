...
#pragma unroll
            for (int j = 0; j < ncols; ++j) {
                float sum;
                if constexpr (is_mxfp_soa_v<type_K>) {
                    sum = vec_dot_fattn_vec_KQ_mxfp_soa<type_K, D, nthreads_KQ>(
...
#pragma unroll
            for (int i_VKQ_0 = 0; i_VKQ_0 < D/2; i_VKQ_0 += nthreads_V*V_rows_per_thread/2) {
                ...
                if constexpr (is_mxfp_soa_v<type_V>) {
                    dequantize_V_mxfp_soa<type_V, half, V_rows_per_thread>(V + k*nb21, tmp, v_i0, V_qs_head_off, V_e_head_off);
                } else {
...
#pragma unroll
            for (int i_VKQ_0 = 0; i_VKQ_0 < D/2; i_VKQ_0 += nthreads_V*V_rows_per_thread/2) {
                ...
                const int64_t v_i0 = 2*i_VKQ_0 + (nthreads_V == WARP_SIZE ? threadIdx.x : threadIdx.x % nthreads_V)*V_rows_per_thread;
                if constexpr (is_mxfp_soa_v<type_V>) {
                    dequantize_V_mxfp_soa<type_V, float, V_rows_per_thread>(V + k*nb21, tmp, v_i0, V_qs_head_off, V_e_head_off);
                } else {
                    dequantize_V(V + k*nb21, tmp, v_i0);
                }
#pragma unroll
...
// MXFP4: only mxfp4-mxfp4 combination (no cross-type combos)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_MXFP4_E2M1, GGML_TYPE_MXFP4_E2M1);
...
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_MXFP8_E4M3, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_MXFP8_E4M3, GGML_TYPE_MXFP8_E4M3);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_MXFP8_E4M3, GGML_TYPE_MXFP8_E4M3);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_MXFP8_E4M3, GGML_TYPE_MXFP8_E4M3);

// MXFP6 E2M3: K=mxfp6_e2m3 with V=mxfp4 (default) or V=mxfp6_e2m3 (max quality)
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_MXFP6_E2M3, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_MXFP6_E2M3, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_MXFP6_E2M3, GGML_TYPE_MXFP4_E2M1);
...
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_MXFP6_E3M2, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_MXFP6_E3M2, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_MXFP6_E3M2, GGML_TYPE_MXFP4_E2M1);
...
extern DECL_FATTN_VEC_CASE( 64, GGML_TYPE_MXFP8_E5M2, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(128, GGML_TYPE_MXFP8_E5M2, GGML_TYPE_MXFP4_E2M1);
extern DECL_FATTN_VEC_CASE(256, GGML_TYPE_MXFP8_E5M2, GGML_TYPE_MXFP4_E2M1);
