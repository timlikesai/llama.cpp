...
TYPES_MMQ = [
    ...
    "GGML_TYPE_IQ1_S", "GGML_TYPE_IQ4_NL", "GGML_TYPE_IQ4_XS", "GGML_TYPE_MXFP4", "GGML_TYPE_MXFP6", "GGML_TYPE_MXFP8", "GGML_TYPE_NVFP4"
]
...
# (K, V) type pairs for the fattn-vec instances: the full TYPES_KV cross product, plus the
# mxfp4 KV cache pair (mxfp4 is not a K type in TYPES_KV)
TYPE_PAIRS = [(type_k, type_v) for type_k in TYPES_KV for type_v in TYPES_KV] + [("GGML_TYPE_MXFP4", "GGML_TYPE_MXFP4")]
for type_k, type_v in TYPE_PAIRS:
