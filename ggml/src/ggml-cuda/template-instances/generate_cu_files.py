...
TYPES_MMQ_W4A4 = ["GGML_TYPE_NVFP4", "GGML_TYPE_MXFP4"]

SOURCE_MMQ_W4A4 = """
DECL_MMQ_CASE_W4A4({type});
"""
TYPES_MMQ_MXA8 = ["GGML_TYPE_MXFP4"]

SOURCE_MMQ_MXA8 = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../mmq.cuh"

DECL_MMQ_CASE_MXA8({type});
"""
...
for type in TYPES_MMQ:
    with open(f"mmq-instance-{get_short_name(type)}.cu", "w") as f:
        if type in TYPES_MMQ_MXA8:
            f.write(SOURCE_MMQ_MXA8.format(type=type))
        else:
