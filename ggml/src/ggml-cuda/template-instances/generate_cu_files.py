...
# MXFP4 MMA instances (Blackwell FP4 flash attention)
HEAD_SIZES_MXFP4 = [64, 128, 256]

SOURCE_FATTN_MMA_MXFP4_START = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../fattn-mma-mxfp4.cuh"

"""

SOURCE_FATTN_MMA_MXFP4_CASE = "DECL_FATTN_MMA_MXFP4_CASE({head_size_kq}, {head_size_v}, {ncols1}, {ncols2});\n"
...
for ncols in [8, 16, 32]:
    for ncols2 in [1, 2, 4, 8]:
        if ncols2 > ncols:
            continue
        ncols1 = ncols // ncols2
        with open(f"fattn-mma-mxfp4-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            f.write(SOURCE_FATTN_MMA_MXFP4_START)
            for head_size_kq in HEAD_SIZES_MXFP4:
                head_size_v = head_size_kq
                f.write(SOURCE_FATTN_MMA_MXFP4_CASE.format(ncols1=ncols1, ncols2=ncols2, head_size_kq=head_size_kq, head_size_v=head_size_v))

# MXFP4 VEC instance (only mxfp4-mxfp4, no cross-type combos)
SOURCE_FATTN_VEC_MXFP4 = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.
...
with open("fattn-vec-instance-mxfp4-mxfp4.cu", "w") as f:
    f.write(SOURCE_FATTN_VEC_MXFP4)
