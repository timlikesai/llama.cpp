...
#pragma unroll
    ...
    // A: 4 registers (16 FP8 values per register = 64 FP8 values, but m16n8k32 uses 4 × 32-bit)
    // B: 2 registers (8 FP8 values per register = 16 FP8 values)
    // scale_vec::1X: 1 E8M0 scale per 32 elements
