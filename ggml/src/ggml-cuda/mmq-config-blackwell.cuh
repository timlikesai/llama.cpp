static constexpr __host__ __device__ ggml_cuda_mmq_config ggml_cuda_mmq_get_config_blackwell(ggml_type type, int J, bool fallback, ggml_prec prec_src1 = GGML_PREC_Q8) {
    if (type == GGML_TYPE_MXFP4 && prec_src1 == GGML_PREC_Q4) {
        // native W4A4 path: e2m1 x e2m1 with the packed FP4 tile
