...
// Data-free optimal e8m0 block scale per format (ref. https://arxiv.org/abs/2607.24377):
#define GGML_MXFP_QMAX_E2M1 7.25f  // E2M1 (maxnorm 6): q* = 29/4
#define GGML_MXFP_QMAX_E4M3 464.0f // E4M3 (maxnorm 448)

// exponent e such that amax*2^(127-e) falls in (qmax/2, qmax]; a tie lands exactly on qmax, which is in range
